(function() {
	var z = function() {
			(function(j, l) {
				...
				function u(a, b, d) {
					var e = b + "defer",
						...
						g = b + "mark",
						h = c.data(a, e, l, true);
					h && (d === "queue" || !c.data(a, f, l, true)) && (d === "mark" || !c.data(a, g, l, true)) && setTimeout(function() {
				...
				function za(a) {
					return function(b, d) {
						...
						if (c.isFunction(d)) for (var e = b.toLowerCase().split(Aa), f = 0, g = e.length, h, k; f < g; f++) h = e[f], (k = /^\+/.test(h)) && (h = h.substr(1) || "*"), o = a[h] = a[h] || [], h = o, h[k ? "unshift" : "push"](d)
					}
				}
				function Z(a, b, c, e, f, g) {
					...
					g = g || {};
					g[f] = true;
					for (var f = a[f], h = 0, k = f ? f.length : 0, o = a === ga, p; h < k && (o || !p); h++) p = f[h](b, c, e), typeof p === "string" && (!o || g[p] ? p = l : (b.dataTypes.unshift(p), p = Z(a, b, c, e, p, g)));
				...
				function Fa(a) {
					if (!ia[a]) {
						...
						if (e === "none" || e === "") {
							...
							b.appendChild(E);
							if (!J || !E.createElement) J = (E.contentWindow || E.contentDocument).document, J.write((m.compatMode === "CSS1Compat" ? "<!doctype html>" : "") + "<html><body>"), J.close();
							d = J.createElement(a);
				...
				var m = j.document,
					...
					c = function() {
						...
						b.extend = b.fn.extend = function() {
							...
							h === x && (g = this, --x);
							for (; x < h; x++) if ((a = arguments[x]) != null) for (c in a) d = g[c], e = a[c], g !== e && (t && e && (b.isPlainObject(e) || (f = b.isArray(e))) ? (f ? (f = false, d = d && b.isArray(d) ? d : []) : d = d && b.isPlainObject(d) ? d : {}, g[c] = b.extend(t, d, e)) : e !== l && (g[c] = e));
							return g
						};
						b.extend({
							...
							map: function(a, c, d) {
								var e, f, g = [],
									x = 0,
									h = a.length;
								if (a instanceof b || h !== l && typeof h === "number" && (h > 0 && a[0] && a[h - 1] || h === 0 || b.isArray(a))) for (; x < h; x++) e = c(a[x], x, d), e != null && (g[g.length] = e);
				...
				c.support = function() {
					...
					if (a.attachEvent) for (k in {
						...
						change: 1,
						focusin: 1
					}) b = "on" + k, d = b in a, d || (a.setAttribute(b, "return;"), d = typeof a[b] === "function"), h[k + "Bubbles"] = d;
				...
				c.fn.extend({
					data: function(a, b) {
						...
						if (typeof a === "undefined") {
							if (this.length && (d = c.data(this[0]), this[0].nodeType === 1)) for (var e = this[0].attributes, f, g = 0, h = e.length; g < h; g++) f = e[g].name, f.indexOf("data-") === 0 && (f = c.camelCase(f.substring(5)), q(this[0], f, d[f]));
							return d
				...
				c.fn.extend({
					...
					promise: function(a) {
						...
						var a = a || "fx",
							...
							k = a + "queue";
						a += "mark";
						for (var o; f--;) if (o = c.data(e[f], h, l, true) || (c.data(e[f], k, l, true) || c.data(e[f], a, l, true)) && c.data(e[f], h, c._Deferred(), true)) g++, o.done(b);
						b();
						return d.promise()
					}
				});
				...
				c.fn.extend({
					...
					toggleClass: function(a, b) {
						...
						return c.isFunction(a) ? this.each(function(d) {
							...
							if (d === "string") for (var f, g = 0, h = c(this), k = b, o = a.split(na); f = o[g++];) k = e ? k : !h.hasClass(f), h[k ? "addClass" : "removeClass"](f);
							else if (d === "undefined" || d === "boolean") this.className && c._data(this, "__className__", this.className), this.className = this.className || a === false ? "" : c._data(this, "__className__") || ""
						})
					},
					hasClass: function(a) {
						for (var a = " " + a + " ", b = 0, c = this.length; b < c; b++) if (this[b].nodeType === 1 && (" " + this[b].className + " ").replace(Ja, " ").indexOf(a) > -1) return true;
						return false
					},
					val: function(a) {
						var b, d, e = this[0];
							...
							if (s && q) {
								...
								if (!b || typeof b === "string" && b.charAt(0) === ".") for (f in b = b || "", q) c.event.remove(a, f + b);
									...
									for (b = b.split(" "); f = b[h++];) if (j = f, k = f.indexOf(".") < 0, o = [], k || (o = f.split("."), f = o.shift(), p = RegExp("(^|\\.)" + c.map(o.slice(0).sort(), xb).join("\\.(?:.*\\.)?") + "(\\.|$)")), m = q[f]) if (d) {
										...
										if (m.length === 0 || e != null && m.length === 1)(!j.teardown || j.teardown.call(a, o) === false) && c.removeEvent(a, f, s.handle), delete q[f]
									} else for (g = 0; g < m.length; g++) if (B = m[g], k || p.test(B.namespace)) c.event.remove(a, j, B.handler, g), m.splice(g--, 1);
				...
				if (!c.support.changeBubbles) {
					var R, Oa = function(a) {
						...
						ba = function(a, b) {
							var d = a.target,
								e, f;
							if (oa.test(d.nodeName) && !d.readOnly && (e = c._data(d, "_change_data"), f = Oa(d), (a.type !== "focusout" || d.type !== "radio") && c._data(d, "_change_data", f), !(e === l || f === e))) if (e != null || f) a.type = "change", a.liveFired = l, c.event.trigger(a, b, d)
						};
				...
				c.each(["live", "die"], function(a, b) {
					c.fn[b] = function(a, e, f, g) {
						...
						for (a = (a || "").split(" ");
						(g = a[h++]) != null;) if (k = fa.exec(g), o = "", k && (o = k[0], g = g.replace(fa, "")), g === "hover") a.push("mouseenter" + o, "mouseleave" + o);
				...
				(function() {
					...
					var p = function(a, b, c, e) {
							...
							else for (k = j.relative[v[0]] ? [b] : p(v.shift(), b); v.length;) a = v.shift(), j.relative[a] && (a += v.shift()), k = y(a, k);
							...
							CHILD: function(a, b) {
								...
								case "nth":
									...
									if (g && (g.sizcache !== f || !a.nodeIndex)) {
										for (var h = 0, d = g.firstChild; d; d = d.nextSibling) if (d.nodeType === 1) d.nodeIndex = ++h;
										g.sizcache = f
									}
									d = a.nodeIndex - e;
				...
				c.fn.extend({
					...
					has: function(a) {
						...
						return this.filter(function() {
							for (var a = 0, e = b.length; a < e; a++) if (c.contains(this, b[a])) return true
						})
					},
					not: function(a) {
				...
				c.extend({
					...
					dir: function(a, b, d) {
						for (var e = [], a = a[b]; a && a.nodeType !== 9 && (d === l || a.nodeType !== 1 || !c(a).is(d));) a.nodeType === 1 && e.push(a), a = a[b];
						return e
					},
					nth: function(a, b, c) {
				...
				c.fn.extend({
					...
					remove: function(a, b) {
						for (var d = 0, e;
						(e = this[d]) != null; d++) if (!a || c.filter(a, [e]).length)!b && e.nodeType === 1 && (c.cleanData(e.getElementsByTagName("*")), c.cleanData([e])), e.parentNode && e.parentNode.removeChild(e);
						return this
					},
					empty: function() {
						for (var a = 0, b;
				...
				c.buildFragment = function(a, b, d) {
					...
					if (a.length === 1 && typeof a[0] === "string" && a[0].length < 512 && h === m && a[0].charAt(0) === "<" && !Sa.test(a[0]) && (c.support.checkClone || !Ta.test(a[0]))) f = true, (g = c.fragments[a[0]]) && g !== 1 && (e = g);
				...
				c.extend({
					...
					clean: function(a, b, d, e) {
						...
						for (var f = [], g, h = 0, k;
						(k = a[h]) != null; h++) if (typeof k === "number" && (k += ""), k) {
					...
					cleanData: function(a) {
						...
						(o = a[k]) != null; k++) if (!o.nodeName || !c.noData[o.nodeName.toLowerCase()]) if (d = o[c.expando]) {
				...
				c.extend({
					...
					ajax: function(a, b) {
						...
						if (e.crossDomain == null) u = Za.exec(e.url.toLowerCase()), e.crossDomain = !(!u || !(u[1] != G[1] || u[2] != G[2] || (u[3] || (u[1] === "http:" ? 80 : 443)) != (G[3] || (G[1] === "http:" ? 80 : 443))));
				...
				c.fn.extend({
					show: function(a, b, d) {
						if (a || a === 0) return this.animate(O("show", 3), a, b, d);
							...
							for (var d = 0, e = this.length; d < e; d++) if (a = this[d], a.style) {
								b = a.style.display;
				...
				c.fx.prototype = {
					...
					step: function(a) {
						...
						if (a || b >= f.duration + this.startTime) {
							...
							return false
						} else f.duration == Infinity ? this.now = b : (a = b - this.startTime, this.state = a / f.duration, this.pos = c.easing[f.animatedProperties[this.prop]](this.state, a, 0, 1, f.duration), this.now = this.start + (this.end - this.start) * this.pos), this.update();
						return true
					}
				};
				c.extend(c.fx, {
				...
				function(a) {
					...
					(b = b.parentNode) && b !== h && b !== g;) {
						...
						if (b === e) {
							k += b.offsetTop;
							j += b.offsetLeft;
							if (c.offset.doesNotAddBorder && (!c.offset.doesAddBorderForTableAndCells || !Zb.test(b.nodeName))) k += parseFloat(d.borderTopWidth) || 0, j += parseFloat(d.borderLeftWidth) || 0;
							e = b.offsetParent
						}
				...
				c.offset = {
					...
					setOffset: function(a, b, d) {
						...
						var f = c(a),
							...
							j = {},
							l = {};
						(e === "absolute" || e === "fixed") && c.inArray("auto", [h, k]) > -1 ? (l = f.position(), e = l.top, k = l.left) : (e = parseFloat(h) || 0, k = parseFloat(k) || 0);
				...
				c.each(["Left", "Top"], function(a, b) {
					...
					c.fn[d] = function(b) {
						...
						return this.each(function() {
							(g = ja(this)) ? g.scrollTo(!a ? b : c(g).scrollLeft(), a ? b : c(g).scrollTop()) : this[d] = b
						})
					}
				});
				c.each(["Height", "Width"], function(a, b) {
		...
		q = z.$,
		ea = z.jQuery,
		ta = q('script[src^="http://blogparts.giffy.me/"]:last'),
	...
	q(function() {
		...
		window.giffy_bp_0013 = {
			...
			init: function() {
				for (i = 0; i < 1; i++) {
					var j = "http://blogparts.giffy.me/0013/ball" + (i + 1) + ".png";
					giffy_bp_0013.ballImageResource[i] = new Image;
					giffy_bp_0013.ballImageResource[i].src = j
				}
				for (i = 0; i < 8; i++) j = "http://blogparts.giffy.me/0013/subball" + (i + 1) + ".png", giffy_bp_0013.subBallImageResource[i] = new Image, giffy_bp_0013.subBallImageResource[i].src = j;
				for (i = 0; i < 20; i++) {
